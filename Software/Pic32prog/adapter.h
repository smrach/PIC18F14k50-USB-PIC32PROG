...
struct _adapter_t {
    ...
    void (*load_executive) (adapter_t *a, const unsigned *pe, unsigned nwords, unsigned pe_version);
    ...
    void (*program_quad_word) (adapter_t *a, unsigned addr, unsigned word0, unsigned word1, unsigned word2, unsigned word3);
